...
2. **Clone this repository.** - `git clone https://github.com/ccampanaon/react-redux-es6.git` or [download the zip](https://github.com/ccampanaon/react-redux-es6/archive/master.zip)
